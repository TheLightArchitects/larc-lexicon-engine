...
mod store {
    ...
    use larc_lexicon_engine::{
        aggregate_corpus_profile, extract_human_turns, flag_pasted_content, render_style_guide,
        word_count, Confidence, LexiconEngine, PatternCategory, Register, SourceKind, SourceRef,
